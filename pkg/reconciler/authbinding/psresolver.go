...
// PodspecableResolver resolves policy subject from Authorizables.
type PodspecableResolver struct {
	tracker         tracker.Interface
	informerFactory pkgapisduck.InformerFactory
}

// NewPodspecableResolver constructs a new PodspecableResolver with context and a callback
...
// PodspecableFromRef resolves podspecable from the reference.
func (r *PodspecableResolver) PodspecableFromRef(ref *corev1.ObjectReference, parent interface{}) (*tracker.Reference, error) {
	if ref == nil {
