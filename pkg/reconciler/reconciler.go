...
import (
	...
	securityscheme "github.com/yolocs/knative-policy-binding/pkg/client/clientset/versioned/scheme"
	securityclient "github.com/yolocs/knative-policy-binding/pkg/client/injection/client"
	"go.uber.org/zap"
...
type Base struct {
	...
	// SecurityClientSet allows us to configure security objects.
	SecurityClientSet clientset.Interface
...
func NewBase(ctx context.Context, controllerAgentName string, cmw configmap.Watcher) *Base {
	...
	base := &Base{
		...
		SecurityClientSet: securityclient.Get(ctx),
...
func init() {
	securityscheme.AddToScheme(scheme.Scheme)
}
