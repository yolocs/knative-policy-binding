...
const (
	reconcilerName      = "PolicyBindings"
	controllerAgentName = "policybinding-controller"
)
...
func NewController(
	...
	r := &psbinding.BaseReconciler{
		GVR: v1alpha1.SchemeGroupVersion.WithResource("policybindings"),
		Get: func(namespace string, name string) (psbinding.Bindable, error) {
			return policybindinginformer.Lister().PolicyBindings(namespace).Get(name)
		},
		DynamicClient: dc,
