...
type EventPolicyInterface interface {
	...
	UpdateStatus(*v1alpha1.EventPolicy) (*v1alpha1.EventPolicy, error)
...
func (c *eventPolicies) UpdateStatus(eventPolicy *v1alpha1.EventPolicy) (result *v1alpha1.EventPolicy, err error) {
	result = &v1alpha1.EventPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("eventpolicies").
