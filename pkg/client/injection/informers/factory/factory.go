...
import (
	...
	externalversions "github.com/yolocs/knative-policy-binding/pkg/client/informers/externalversions"
	client "github.com/yolocs/knative-policy-binding/pkg/client/injection/client"
...
func Get(ctx context.Context) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/yolocs/knative-policy-binding/pkg/client/informers/externalversions.SharedInformerFactory from context.")
	}
