...
import (
	...
	externalversions "github.com/yolocs/knative-policy-binding/pkg/client/istio/informers/externalversions"
	client "github.com/yolocs/knative-policy-binding/pkg/client/istio/injection/client"
...
func Get(ctx context.Context) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/yolocs/knative-policy-binding/pkg/client/istio/informers/externalversions.SharedInformerFactory from context.")
	}
