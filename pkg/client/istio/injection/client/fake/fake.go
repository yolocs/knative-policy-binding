...
import (
	...
	fake "github.com/yolocs/knative-policy-binding/pkg/client/istio/clientset/versioned/fake"
...
func Get(ctx context.Context) *fake.Clientset {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/yolocs/knative-policy-binding/pkg/client/istio/clientset/versioned/fake.Clientset from context.")
	}
