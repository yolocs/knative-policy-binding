...
// PolicyBinding describes a policy binding.
...
var (
	_ apis.Validatable   = (*PolicyBinding)(nil)
	_ apis.Defaultable   = (*PolicyBinding)(nil)
	_ apis.HasSpec       = (*PolicyBinding)(nil)
	_ runtime.Object     = (*PolicyBinding)(nil)
	_ kmeta.OwnerRefable = (*PolicyBinding)(nil)
)

// PolicyBindingSpec is the spec of the binding.
